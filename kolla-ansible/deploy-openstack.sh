...
kolla-genpwd -p /home/gcp_user/.local/share/kolla-ansible/etc_examples/kolla/passwords.yml && cp /home/gcp_user/.local/share/kolla-ansible/etc_examples/kolla/passwords.yml ./
