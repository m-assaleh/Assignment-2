...
kolla-genpwd -p /home/ubuntu/kolla-env/share/kolla-ansible/etc_examples/kolla/passwords.yml && cp /home/ubuntu/kolla-env/share/kolla-ansible/etc_examples/kolla/passwords.yml ./
